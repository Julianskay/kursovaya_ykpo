...
bool checkWay (int start, int finish)
{
	...
	prov (graph);
	cout << "¬ведите вершину, к которой вы хотите найти путь:  ", cin >> ii;
	inputch (ii);
	--ii;
	/*for (int i = 0; i < k; i++) // исходно все вершины равны 0
		nodes[i] = 0;
	cout << "¬ведите начальную координату:	", cin >> ii;
	inputch (ii); ii--;
	cout << "¬ведите конечную координату:	", cin >> ff;
	inputch (ff); ff--;
